...
import {IconArrowUpRight, IconMenuDeep, IconWorld} from "@tabler/icons-react";
                ...
                `}>
                    ...
                    >
                        <div className="relative w-7 h-7 md:w-8 md:h-8 flex items-center justify-center">
                            <div
                                className="absolute inset-0 bg-primary/10 rounded-lg rotate-45 group-hover:rotate-90 transition-transform duration-500"/>
                            <div
                                className="w-3.5 h-3.5 md:w-4 md:h-4 bg-primary rounded-sm shadow-[0_0_15px_rgba(var(--primary),0.5)]"/>
                        </div>
