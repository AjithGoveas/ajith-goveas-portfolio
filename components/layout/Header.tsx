                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-3xl font-sofia text-foreground">myBio</span>
                        </div>
                    </motion.div>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        <div
                            className="flex items-center rounded-lg border border-border bg-background/70 backdrop-blur px-2 sm:px-4 py-2 mx-2">
                            {navItems.map((item) => (
                                <Button
                                    key={item.name}
