...
export default function AboutSection() {
    ...
    return (
        <section id="about" className="py-16 md:py-44 bg-background relative overflow-hidden">
            <div
                className="absolute inset-0 z-0 opacity-[0.03] mask-[radial-gradient(ellipse_at_center,black,transparent)] pointer-events-none">
                <div
            ...
            <div
                className="absolute top-1/2 left-0 -translate-y-1/2 w-150 h-150 bg-primary/10 blur-[180px] pointer-events-none -z-10 animate-pulse"/>
            <div
